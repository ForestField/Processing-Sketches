...
void setup() {
  ...
  sine = new SineWave(440, 0.06, out.sampleRate());
  sine1= new SineWave(440, 0.06, out.sampleRate());
  sine2= new SineWave(440, 0.06, out.sampleRate());
  sine3= new SineWave(440, 0.06, out.sampleRate());
  square1 = new SquareWave(440, .06, out.sampleRate());
  square2 = new SquareWave(440, .06, out.sampleRate());
  // set the portamento speed on the oscillator to 200 milliseconds
  sine.portamento(200);
  sine1.portamento(200);
  sine2.portamento(200);
  sine3.portamento(200);  // add the oscillator to the line out
  square1.portamento(200);
