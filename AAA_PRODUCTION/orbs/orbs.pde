...
class Orb{
 ...
 Orb(float tempW, float tempH, color tempClr){
   w=tempW;
   h=tempH;
   clr=tempClr;
 }
...
void draw()
{
  ...
  outerOrb = new Orb ((a*10),(random(0,255))*h_on_off,color (r,g,b,50));
  outerOrb1 = new Orb ((a*5),(val+100)*h_on_off,color (255-2, 255,255-2*b,75));
  midOrb = new Orb ((a*2),(val+50)*h_on_off,color (random(0,255),g,b,100));
  innerOrb1= new Orb ((a),(val+25)*h_on_off,color ((255-r), (255), (255-(b)),255)); 
  innerOrb = new Orb (a/2,val*h_on_off,color (r-20,g-20,b-20));
