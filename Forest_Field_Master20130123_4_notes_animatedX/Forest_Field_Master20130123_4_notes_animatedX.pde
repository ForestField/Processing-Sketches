...
if(closeCount<2){
line(closeCount, farCount,width/2, height/2);
line(0,0,width/4, height/4);
ellipse(3*width/4,3*height/4, dm, dm);
delay(d);
}
if(closeCount<3){
line(width/6, height/6, width/2, height/2);
...
if(closeCount<4){
line(width/8,height/8, width/2, height/2);
...
if(closeCount>=4){
line(width/10, height/10, width/2, height/2);
