...
//**MAIN HEADER-------------AUDIO------------**\\
  ...
  sineG = new SineWave(145.00, off, out.sampleRate());//1st sine wave - frequency between G and an A
  ...
  squareB = new SquareWave(880, .5, out.sampleRate()); 
 //squareB = new SineWave(120.21, off, out.sampleRate());low option 4th sine wave - low b flat
  //squareB = new SineWave(00.01, off, out.sampleRate());//low option 4th sine wave - low b flat
  // set the portamento speed on the oscillator to 200 milliseconds
  sineG.portamento(200);
  sineC.portamento(200);
  sineF.portamento(200);
  squareB.portamento(0);
