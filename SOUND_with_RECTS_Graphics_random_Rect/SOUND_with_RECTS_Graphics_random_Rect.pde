...
void setup() {
  ...
  square1 = new SquareWave(440, .5, out.sampleRate());
  square2 = new SquareWave(440, .5, out.sampleRate());
...
void draw()
{
  ...
  outerRect1 = new Rectangle ((a*5),(val+100)*h_on_off,color (255-2, random(0,255),255-2*b,75));
